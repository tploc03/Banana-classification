...
model = models.Sequential(name='banana_classifier_trained_002')
model.add(layers.Input(shape=input_shape))
model.add(layers.Rescaling(1./255)) #255->1 , 0
...
model.save('./output/banana_classifier_trained_002.keras')
